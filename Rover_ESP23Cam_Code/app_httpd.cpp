...
static esp_err_t cmd_handler(httpd_req_t *req)
{
    ...
    else if (!strcmp(variable, "move")) // 3250, 4875, 6500
    {
        Serial.println();
        if(val == 1){
            Serial.write('u');
...
<html>
    ...
    <figure>
      <!-- <div id="stream-container" class="image-container hidden">
        ...
        <center>
            <div id="stream-container" class="image-container hidden">
                <div width="100%" class="close" id="close-stream" align="right">×</div>
                <img width="100%" id="stream" src="">
              </div>
            <div width="80%" align="center">
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td class="button" onClick="try{fetch(document.location.origin+'/control?var=move&val=1');}catch(e){}"><span class="arrows" >&#8679;</span></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="button" onClick="try{fetch(document.location.origin+'/control?var=move&val=2');}catch(e){}"><span class="arrows" >&#8678;</span></td>
                        <td class="button" onClick="try{fetch(document.location.origin+'/control?var=move&val=5');}catch(e){}"><span class="arrows" >&#8858;</span></td>    
                        <td class="button" onClick="try{fetch(document.location.origin+'/control?var=move&val=3' );}catch(e){}"><span class="arrows" >&#8680;</span></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td class="button" onClick="try{fetch(document.location.origin+'/control?var=move&val=4');}catch(e){}"><span class="arrows" >&#8681;</span></td>
                        <td></td>
                    </tr>
                    <tr/>
                    </table>
